...
### Phase 1: Persona Loader & Assembly Engine
- [ ] Task: Write unit tests for persona resolution, file assembly, and embedded fallback in `tests/test_persona.py`
- [ ] Task: Implement `src/persona.py` loading `/home/azzar/agent_persona` with embedded backup
